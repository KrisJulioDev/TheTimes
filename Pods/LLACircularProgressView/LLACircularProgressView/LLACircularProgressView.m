...
- (void)drawRect:(CGRect)rect {
    ...
    if ( self.isPlaying ) {
        ...
        CGContextMoveToPoint(ctx, CGRectGetMidX(self.bounds) - self.bounds.size.width / 5, CGRectGetMidY(self.bounds) - self.bounds.size.height / 5);
        CGContextAddLineToPoint(ctx, CGRectGetMidX(self.bounds) + self.bounds.size.width / 5, CGRectGetMidY(self.bounds));
        CGContextAddLineToPoint(ctx, CGRectGetMidX(self.bounds) - self.bounds.size.width / 5, CGRectGetMidX(self.bounds) + self.bounds.size.width / 5);
